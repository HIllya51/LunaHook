...
#define MONO_FUNCTIONS_INITIALIZER \
    { "mono_string_to_utf8", 0, 0, CODEC_UTF16|NO_CONTEXT, SpecialHookMonoString } \
  , { "mono_string_to_utf8_checked", 0, 0, CODEC_UTF16|NO_CONTEXT, SpecialHookMonoString } \
  , { "mono_string_to_utf16", 0, 0, CODEC_UTF16|NO_CONTEXT, SpecialHookMonoString } \
  , { "mono_string_intern", 0, 0, CODEC_UTF16|NO_CONTEXT, SpecialHookMonoString } \
  , { "mono_string_is_interned", 0, 0, CODEC_UTF16|NO_CONTEXT, SpecialHookMonoString } \
  , { "mono_marshal_string_to_utf16", 0, 0, CODEC_UTF16|NO_CONTEXT, SpecialHookMonoString } \
  , { "mono_string_hash", 0, 0, CODEC_UTF16, SpecialHookMonoString } \
  , { "mono_string_chars", 0, 0, CODEC_UTF16, SpecialHookMonoString } \
  , { "mono_string_length", 0, 0, CODEC_UTF16, SpecialHookMonoString } \
  , { "mono_utf8_from_external", 1, 0, USING_STRING|CODEC_UTF8, nullptr } \
  , { "mono_string_from_utf16", 1, 0, CODEC_UTF16, nullptr } \
  , { "mono_unicode_from_external", 1, 0, CODEC_UTF16, nullptr } \
  , { "mono_unicode_to_external", 1, 0, CODEC_UTF16, nullptr } \
  , { "mono_string_new", 2, 0, USING_STRING|CODEC_UTF8, nullptr } \
  , { "mono_string_new_wrapper", 1, 0, USING_STRING|CODEC_UTF8, nullptr }
...
#define MONO_FUNCTIONS_INITIALIZER \
    { "mono_string_to_utf8", 0, 0, USING_STRING|CODEC_UTF16|NO_CONTEXT, SpecialHookMonoString } \
  , { "mono_string_to_utf16", 0, 0, USING_STRING|CODEC_UTF16|NO_CONTEXT, SpecialHookMonoString } 
#endif